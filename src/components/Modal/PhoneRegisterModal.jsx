...
const PhoneRegisterModal = forwardRef(function PhoneRegisterModal(
    ...
    return (
        <Modal
            ...
            styles={{
                content: {
                    maxWidth: 404, width: "92vw", padding: 24,
                    borderRadius: token.borderRadiusLG, background: token.colorBgElevated,
        ...
        >
            <div style={{ textAlign: "center", marginBottom: 8 }}>
                <Title level={3} style={{ margin: 0, lineHeight: "28px" }}>Đăng ký</Title>
                <Text type="secondary">Tham gia vào thị trường ReEV</Text>
            </div>

            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                <Form form={form} layout="vertical" onFinish={handleFinish} requiredMark={false} style={{ marginTop: 4 }}>
                    <Form.Item
                        name="phoneNumber"
                        label="Số điện thoại"
                        rules={[
